...
public class TinkersSmelteryMulti extends SimpleSlimefunItem<ItemUseHandler> implements NotPlaceable {
    ...
    public TinkersSmelteryMulti(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, org.bukkit.inventory.ItemStack[] recipe) {
    ...
    public ItemUseHandler getItemHandler() {
        return e -> {
            ...
            if (MultiBlockAssembler.assembleAround(layout(), customBlocks(), center, e.getPlayer())) {
